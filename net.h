...
static const unsigned short DEFAULT_PORT = htons(9333);
...
bool AddAddress(CAddrDB& addrdb, const CAddress& addr, bool fForce=false);
...
static const unsigned char pchMessageStart[4] = { 0xbc, 0xa5, 0xca, 0x5e };
